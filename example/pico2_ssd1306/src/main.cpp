...
//   2. Fill it with LCD framebuffer pixels via fillScanline.
...
//
// q_colour_valid is bypassed entirely; Core 0 can dedicate itself to
// processSpiRingBuf/processI2cRingBuf without timer preemption.
//
