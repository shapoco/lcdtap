...
#include "3line_spi_slave.pio.h"
#include "config.h"

static_assert(PIN_SPI_CS == SPI_CS_PIN,
              "PIN_SPI_CS mismatch with 3line_spi_slave.pio");
...
// =============================================================================
// GPIO interrupt handler  (RESX pin; CS pin)
// =============================================================================
...
static void spiSlaveInit(uint prog_offset) {
  ...
  pio_sm_config c =
      three_line_spi_slave_program_get_default_config(prog_offset);
  sm_config_set_in_pins(&c, PIN_SPI_MOSI);  // IN_BASE=GPIO4
